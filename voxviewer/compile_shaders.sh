slang_command="slangc -DFALCOR_MATERIAL_INSTANCE_SIZE=128 -DFALCOR_NVAPI_AVAILABLE=0 -I Falcor/Source/Falcor -O3 -validate-uniformity -warnings-as-errors all"
